-- Action Aerials Marketplace Database Schema (Fixed)
...
CREATE TABLE public.marketplace_profiles (
  ...
  role TEXT NOT NULL DEFAULT 'surfer', -- Using TEXT instead of user_role enum
  phone TEXT,
  bio TEXT,
  ...
  CONSTRAINT valid_role CHECK (role IN ('photographer', 'surfer'))
);
